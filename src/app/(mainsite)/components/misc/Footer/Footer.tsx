  ...
  return (
    <footer className={styles.footer}>
      ...
      <div className={styles.socialLinks}>
          <a href="https://www.facebook.com/profile.php?id=61557764952390" target="_blank" className={styles.socialLink}>
          ...
          <a href="https://www.instagram.com/itsallaboutlifeinsurance/" target="_blank" className={styles.socialLink}>
